...
9. [Future Tools](https://www.futuretools.io/)
2. [Hugging Face](https://huggingface.co/)
3. [SerpApi](https://serpapi.com/users/sign_in)
4. [LabLab AI](https://lablab.ai/)
5. [Modular](https://www.modular.com/)
6. [Matrix Multiplication](http://matrixmultiplication.xyz/)
7. [GitHub Online 3D Viewer](https://github.com/kovacsv/Online3DViewer/wiki)
8. [3D Viewer Online](https://www.3dvieweronline.com/plans/)
9. [CodeSandbox](https://codesandbox.io/s/4hhe7i)
10. [Mux](https://www.mux.com/)
11. [Headless UI](https://headlessui.com/)
12. [Tailwind CSS Components](https://tailwindcomponents.com/components)
13. [Canva](https://www.canva.com/en_gb/)
14. [MVS](https://mvs.org/)
15. [Mural](https://app.mural.co/t/incaendo8039/home)
16. [OpenAI Labs](https://labs.openai.com/e/W2QTr6rJr6igDN9Yhaja0VKo)
17. [NASA JPL Explorer](https://nasa-jpl.github.io/explorer-1/?path=/story/introduction--page)
18. [Cloudflare Dashboard](https://dash.cloudflare.com/login)
19. [Flowbite](https://flowbite.com/)
20. [Google Chrome Extensions Samples](https://github.com/GoogleChrome/chrome-extensions-samples/blob/main/api-samples/action/demo/index.js)
21. [React Native Boilerplate](https://github.com/thecodingmachine/react-native-boilerplate)
...
9. [Logo Maker Mybrand](https://mybrandnewlogo.com/)
10. [Logo Maker Looka](https://looka.com/)
...
4. [Mux](https://mux.com/)
5. [Gradients](https://gradients.shecodes.io/gradients/835#gradient)

### Blogs/Articles:
1. [OpenAI Blog - ChatGPT Plugins](https://openai.com/blog/chatgpt-plugins)

### Documentation:
1. [JS.LangChain Documentation](https://js.langchain.com/docs/)
2. [TensorFlow Documentation](https://www.tensorflow.org/)
3. [PyTorch Documentation](https://pytorch.org/)
4. [Auth0 Management API Documentation](https://auth0.com/docs/api/management/v2?_ga=2.258667018.1455446948.1586769776-1408454643.1584009394#!/Users/get_user_roles)
5. [Getty Images Developer Documentation](https://developer.gettyimages.com/docs/)
6. [Mixpanel Documentation](https://docs.mixpanel.com/docs/getting-started/what-is-mixpanel)
